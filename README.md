...
- **Three cards to a row at most** — the list is a grid that flows to the page width, but it stops at three columns however wide the window gets: a supply card holds a 2x2 block of tiles, and past three across those tiles are narrower than the words in them. Two columns at a laptop width, one on a phone
