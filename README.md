...
- **Cleaning tracker** — items show "Cleaning due" or "Cleaned today/yesterday/N days ago"; one-tap **Mark cleaned**, plus a **Mark all due items cleaned** button for the daily routine. The add/edit form groups fields into **Cleaning · Replacement · Spares** sections (matching the native iOS app) and lets you set both the last-cleaned and last-replaced dates directly
